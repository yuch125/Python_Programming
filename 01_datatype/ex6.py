...
# 3. 문자열은 (슌서)가 있다 -> (Sequnce) (인덱싱, 슬라이싱 가능)
...
# str.__set setitem이 없어서 바꿀 수 없음
# list.__setitem__ setitem 있어서 바꿀 수 있음
...
print(
    next(it)
)  # 인덱스 1을 반환하고, 다음 위치(인덱스 2)로 이동, 이터레이터 개체보다 인덱스 커지면 오류 생김
...
a, b, c, d, e, f = s  # 받는 개수와 같아야함
print(a, b, c, d, e, f)

# 확장 언패킹
a, *b, c = s
print(a, b, c)  # 나머지 부분은 리스트로, 별은 오직 한개만 사용 가능

# =========================================================
# 3. 문자열은 순서가 있다 -> Sequence -> index를 매길 수 있다.
# =========================================================
...
print(a[::1])  # Python 출력 (step이 양수이면 끝까지, 마지막 인덱스 포함) 다 생략
print(a[0:6:1])  # Python 출력 다 넣기
