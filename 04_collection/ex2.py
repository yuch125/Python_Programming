...
result2 = ori.copy()  # 원본이 값이 같이 바뀜
print(id(ori[0]), id(result2[0]))
result2[0].append(10)
...
result2 = copy.deepcopy(ori)  # 사본만 값이 같이 바뀜
...
# a, b, c = zip(subjects, scores, strict=True)  # strict True를 해야 길이가 맞아야 오류 발생시킴, False면 에러 안남
print(a, b, c)
...
# list(x) : x를 순회해서 하나 하나씩 뽑아 리스트에 넣음
